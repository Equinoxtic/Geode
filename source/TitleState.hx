...
class TitleState extends MusicBeatState
{
	...
	var ngSpr:FlxSprite;
	var titleGradient:FlxSprite;
	var credTitleGradient:FlxSprite;
	var gradientTwn:FlxTween;
	var credGradientTwn:FlxTween;
	...
	*/
	...
	override public function create():Void
	{
		...
		if(ClientPrefs.checkForUpdates && !closedState) {
			...
			var http = new haxe.Http("https://raw.githubusercontent.com/Equinoxtic/Geode/master/gitVersion.txt");

			http.onData = function (data:String)
			{
				updateVersion = data.split('\n')[0].trim();
				var curVersion:String = MainMenuState.geodeEngineVersion.trim();
	...
	function startIntro()
	{
		...
		titleGradient = new FlxSprite().loadGraphic(Paths.image("title_gradient"));
		titleGradient.scrollFactor.set();
		titleGradient.screenCenter();
		titleGradient.alpha = 0;
		titleGradient.antialiasing = ClientPrefs.globalAntialiasing;
		...
		*/
		...
		add(titleGradient);
		titleGradient.shader = swagShader.shader;
		add(gfDance);
		...
		credTitleGradient = new FlxSprite().loadGraphic(Paths.image("title_gradient"));
		credTitleGradient.scrollFactor.set();
		credTitleGradient.screenCenter();
		credTitleGradient.alpha = 0;
		credTitleGradient.antialiasing = ClientPrefs.globalAntialiasing;
		credGroup.add(credTitleGradient);
		credTitleGradient.shader = swagShader.shader;

		gradientTwn = FlxTween.tween(titleGradient, {alpha: 0.95}, 2.35);
		credGradientTwn = FlxTween.tween(credTitleGradient, {alpha: 0.075}, 3.15);
